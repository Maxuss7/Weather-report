...
def handle_http_error(e: HTTPStatusError, default_message: str = "Unexpected error occurred"):
    """
    ...
    if e.response.status_code == 404:
        ...
        raise HTTPException(status_code=502, detail="Weather service is currently unavailable.")
    else:
